        ...
        <CardContent className="flex-1">
          <div className="h-full flex flex-col md:flex-row gap-8">
            <div className="flex-1 space-y-6">
              ...
              >
                <TabsList className="h-10 w-full grid grid-cols-2 bg-[#452634] text-lg">
                ...
                <TabsContent value="email">
                  <div className="space-y-4">
                    ...
                    <Button
                      className="py-7 px-8 bg-[#682945] font-bold rounded-full uppercase"
              ...
              <div className="space-y-4">
                  ...
                  <div className="space-y-2 flex-1">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <Input
                        ...
                        value={color}
                        onChange={(e) => setColor(e.target.value)}
                        className="flex-1 border-2 h-12 bg-transparent  border-white/70 focus:border-[#057FFF]/70 rounded-md outline-none focus-visible:ring-0 placeholder:text-gray-400 text-white"
                      />
                    </div>
                  </div>
                  <div className="space-y-2 flex-1">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <Input
                        ...
                        value={color}
                        onChange={(e) => setBgColor(e.target.value)}
                        className="flex-1 bg-white border-2 h-12 bg-transparent text-white  border-white/70 focus:border-[#057FFF]/70 rounded-md outline-none focus-visible:ring-0 placeholder:text-gray-400"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="logo" className="font-bold text-[#fff]">
                    Logo
                  </Label>
            ...
            <div className="relative flex-1 bg-[#272727] rounded-lg flex flex-col justify-center space-y-6">
              <span>
